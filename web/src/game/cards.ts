export namespace CardsJS {
    ...
    let data = new Map<GlobalEventHandlers, Card>();
    ...
    export class Card {
        ...
        constructor(public id: number) {
            ...
            this.element.onclick = function (this: GlobalEventHandlers, _): void {
                let card: Card = data.get(this)!;
                if (card.container) {
                    let handler = card.container.clickHandler;
                    if (handler) {
                        handler.func.call(handler.context || window, card);
                    }
                }
            }
